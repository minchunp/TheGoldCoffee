...
function EditProduct({ params }: { params: { id: string } }) {
   ...
   const handleUpdate = async () => {
      try {
         ...
         const response = await axios.put(`http://localhost:3001/topping/update/${params.id}`, toppingData, {
            headers: {
               ...
               <div className="container-add-product">
                  <div className="box-demo-add">
                     <div className="box-featured-product">
                        <div className="product-image">
                           {!image && topping && <img src={`${process.env.NEXT_PUBLIC_IMAGE_TOPPING_URL}${topping.img_topping}`} alt="Product" />}
                  ...
                  <div className="box-input-add">
                     <div className="element-input">
                        <p>Tên sản phẩm</p>
                        <input type="text" id="name-product" placeholder="Tên sản phẩm" value={name} onChange={(e) => setName(e.target.value)} />
                     </div>
                     <div className="element-input">
                        <p>Tên danh mục</p>
                     ...
                     <div className="element-input">
                        <p>Giá sản phẩm</p>
                        <input type="text" id="price-product" placeholder="Giá sản phẩm" value={price} onChange={(e) => setPrice(e.target.value)} />
                     </div>
                     <div className="element-input">
                        <p>Trạng thái</p>

  ...
  const blogList: BLogInterface[] = [
    {
      ...
      img_blog:
        "thecoffeehouse_caphehighlight01_de40c0102a954c50a328f7befcdd82bd_grande.jpg",
      date_blog: "01/06/2024",
      content_blog: "",
      sumary_blog:
        "Dẫu qua bao nhiêu lớp sóng thời gian, người ta vẫn có thể tìm lại những dấu ấn thăng trầm của một Sài Gòn xưa cũ. Trên những góc phố,...",
      status_blog: 1,
    },
    {
      _id: "sfisnoifmodfosdmfosd",
        ...
        <div className="boxcenter">
          <div className="container-tea-day">
            <div className="content-tea-day">
              ...
              <p>
                Với hương vị nhẹ nhàng và thanh thoát, không chỉ là một thức
                uống quen thuộc mà còn là một phần quan trọng trong văn hóa
                nhiều quốc gia. Từ những lá trà tươi ngon được hái từ những đồi
                xanh mướt, trải qua quá trình chế biến tinh tế, mỗi tách trà đều
                mang trong mình sự tinh túy của thiên nhiên.
              </p>
        ...
        <div className="boxcenter">
          ...
          <div className="main-desc-bannerQC">
            ...
            <div className="button-bannerQC">
              <a href="#!">
                <button className="main-btn main-btn__banner-introduce">
                  Thử ngay
                </button>
              </a>
            </div>
